        ...
        fn = function(c) {
          ...
          if (keys.length > opts.menuLimit) {
            ...
            for (o = 0, len3 = ref2.length; o < len3; o++) {
              ...
              filterItem.append($("<span class='small'>").text(" (" + v + ")"));
          ...
          // ediat by sbwoo. make click button clear.
          // triangleLink = $("<span>").addClass('pvtTriangle').html(" &#x25BE;").bind("click", showFilterList);
          triangleLink = $("<a style='padding:0 5px 0 3px;' class='btn btn-default pull-right'><i class='pvtTriangle fa fa-caret-down fa-lg' style='color:#000'></i></a>").bind("click", showFilterList);

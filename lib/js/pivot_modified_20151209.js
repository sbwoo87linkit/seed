  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
    ...
    try {
      ...
      _fn = function(c) {
        ...
        triangleLink = $("<a style='padding:0 5px 0 3px; ' class='btn btn-default pull-right'><i class='pvtTriangle fa fa-caret-down fa-lg' style='color:#096AAF'></i></a>").bind("click", showFilterList);
        // modified by sbwoo
        // triangleLink = "";
